...
public class CustomerService {
    ...
    public String registerCustomer(String consumerNumberStr, String title, String name, String address,
        ...
        Consumer consumer = new Consumer(consumerNumber, customerID, address, customerType, "Active");
        ArrayList<Consumer> consumers = new ArrayList<>();
        consumers.add(consumer);
        Customer customer = new Customer(customerID, title, name, address, mobile, email, password,consumers,false);
    ...
    public void processPayment(Payment payment, String[] billIds) throws SQLException {
        ...
        for (String billId : billIds) {
            billDAO.updateBillStatus(billId, "Paid", payment.getTransactionDate());
        }
    }
